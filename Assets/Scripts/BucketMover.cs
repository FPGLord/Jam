...
public class BucketMover : MonoBehaviour
{
    ...
    [SerializeField] private UnityEvent _OnStartMoveToBomb;
    [SerializeField] private UnityEvent _OnFinishMoveToBomb;
